...
import 'notification_service.dart'; // ================= NEW: IMPORT NOTIFICATION SERVICE =================
...
class DatabaseService {
  ...
  Future<bool> placeOrder({
    ...
    try {
      ...
      // ১. নতুন অর্ডার আসলে কিচেনকে নোটিফিকেশন পাঠানো
      await _notificationService.notifyKitchenNewOrder(
      ...
      // ২. ডিজিটাল পেমেন্ট হলে অ্যাডমিনকে নোটিফিকেশন পাঠানো
      if (paymentMethod != 'Cash') {
        await _notificationService.notifyAdminDigitalPayment(
          restaurantId: restaurantId,
          tableNo: tableNumber,
          customerName: customerName,
  ...
  Future<void> updateOrderStatus(
    ...
    try {
      ...
      // ================= NEW: NOTIFY WAITER WHEN FOOD IS READY =================
      if (newStatus == 'Ready') {
        try {
          ...
          if (orderDoc.exists) {
            ...
            await _notificationService.notifyWaiterFoodReady(
